                    ...
                    onPressed: () {
                      if (_breakfastScheduleHourController.text == "") {
                        ...
                        showDialog(
                          ...
                          double.parse(_snackScheduleHourController.text) >
                              23) {
                        showDialog(
                          context: context,
                          builder: (context) => AlertDialog(
                        ...
                        showDialog(
                          ...
                          double.parse(_lunchScheduleHourController.text) >
                              59) {
                        showDialog(
                          context: context,
                          builder: (context) => AlertDialog(
                      ...
                      } else if (double.parse(_dinnerScheduleHourController.text) < 0 || double.parse(_dinnerScheduleHourController.text) > 59) {
                        showDialog(
                          context: context,
                          builder: (context) => AlertDialog(
                            backgroundColor: Color.fromARGB(255, 232, 80, 69),
                      ...
                      } else if (double.parse(_dinnerScheduleMinuteController.text) < 0 || double.parse(_dinnerScheduleMinuteController.text) > 59) {
                        showDialog(
                          context: context,
                          builder: (context) => AlertDialog(
                            backgroundColor: Color.fromARGB(255, 232, 80, 69),
